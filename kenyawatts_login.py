...
def main():
    ...
    # ── Clean page switching — store previous selection and rerun on change ───
    # This fully clears the previous page before rendering the new one,
    # preventing content bleed-through between tabs
    if st.session_state.get("_current_page") != selected:
        st.session_state["_current_page"] = selected
        st.rerun()
    ...
    # Single placeholder — completely replaced each render — no bleed-through
